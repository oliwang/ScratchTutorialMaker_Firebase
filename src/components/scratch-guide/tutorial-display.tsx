        ...
        return (
            ...
            <Card className="bg-card border border-border shadow-lg transition-all duration-300 ease-in-out animate-in fade-in-50">
                <CardHeader>
                    ...
                    <CardDescription className="text-base">This tutorial is generated by an AI model. It may not be 100% accurate. Please verify the information before using it.</CardDescription>
                </CardHeader>
                                            ...
                                            <TableRow key={tutorialState.data.parsedBlocks.stage.name}>
                                                ...
                                                <TableCell>
                                                    {tutorialState.data.parsedBlocks.stage.costumes.map((costume) => (
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            <AssetPreviewCell assetInfo={{...costume, type: costume.dataFormat}} uploadedFile={uploadedFile} key={costume.md5ext} />
                                                        </div>
                                                    ))}
                                                </TableCell>
                                                <TableCell>
